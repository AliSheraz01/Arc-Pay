...
// Arc Mainnet Contracts (Configurable via ENV)
export const MAINNET_CONTRACTS: NetworkContracts = {
  registryAddress: (process.env.NEXT_PUBLIC_USERNAME_REGISTRY || '0x1000000000000000000000000000000000000001') as `0x${string}`,
  routerAddress: (process.env.NEXT_PUBLIC_PAYMENT_ROUTER || '0x2000000000000000000000000000000000000002') as `0x${string}`,
  bountyEscrowAddress: (process.env.NEXT_PUBLIC_BOUNTY_ESCROW || '0x3000000000000000000000000000000000000003') as `0x${string}`,
